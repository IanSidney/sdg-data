...
national_indicator_description: >-
  These data show the number of neonatal deaths per 1,000 live births in the UK. Disaggregations are, however, mostly available only for England and Wales. See the Available Disaggregations field for more information. Data presented by the UN may differ as a Beyesian model is used for the
